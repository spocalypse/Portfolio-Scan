...
export default function Home() {
  const { metrics, findings, meta } = loadSampleAnalyze();
    ...
    >
      <header style={{ display: "flex", flexDirection: "column", gap: "8px", paddingBottom: "32px" }}>
        ...
        <p style={{ margin: 0, fontSize: "var(--step-3)", color: "var(--muted)", maxWidth: "36em" }}>
          Static demo against the frozen metrics fixture. No live API. Numbers below are
          computed holdings weights and risk contributions — not account balances.
        </p>
      </header>
